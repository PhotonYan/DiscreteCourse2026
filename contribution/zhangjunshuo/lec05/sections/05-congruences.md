...
定义 $\overline a+\overline b=\overline{a+b}$、$\overline a\,\overline b=\overline{ab}$。若 $a\equiv a'$、$b\equiv b'$，则 $a+b\equiv a'+b'$、$ab\equiv a'b'$，所以运算不依赖代表元，称为**良定义**。

## 什么时候可以消去

同余式不能随便约去乘因子。例如 $2\cdot1\equiv2\cdot4\pmod6$，但 $1\not\equiv4\pmod6$。

**可逆判据。** $\overline c$ 在模 $m$ 下有乘法逆元，当且仅当 $\gcd(c,m)=1$。
